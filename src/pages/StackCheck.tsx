...
// invariants (GpuParityCheck), which lessons depend on and which have no
// other mount point. A temporary lesson-02 gap-figure harness lived here
// briefly (df8405a) and was committed by accident; if this page is ever
// borrowed as a scratch harness again, restore it before committing —
// while it is borrowed, the invariant checks are mounted NOWHERE.
  ...
  return (
    <div className="prose">
      ...
      <p>
        ...
        CPU/GPU agreement, diffusion convergence):
      </p>
      <GpuParityCheck />
    </div>
  )
